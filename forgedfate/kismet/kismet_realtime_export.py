...
class KismetExportClient:
    ...
    async def connect_and_monitor(self):
        ...
        # Use the correct WebSocket path and authentication from browser
        uri = f"ws://{self.kismet_host}:{self.kismet_port}/devices/views/all/monitor.ws?user=kismet&password=P%40ssw0rd%21"
    ...
    async def connect_event_bus(self):
        ...
        uri = f"ws://{self.kismet_host}:{self.kismet_port}/eventbus/events.ws?user=kismet&password=P%40ssw0rd%21"
